...
public class PublicMergeSorterTest {
	...
	public void testDivideEmpty() throws Exception {
		ms.split(empty, output1, output2);
	...
	public void testDivideNSplitsEvenly() throws Exception {
		...
		ms.split(q, output1, output2);
		assertTrue(((output1.getSize() == 5) && (output2.getSize() == 6)) ||
				   ((output1.getSize() == 6) && (output2.getSize() == 5)));;
	}
	...
	public void testMergeSort() throws Exception {
		...
		assertEquals(10, sorted.getSize());
		for (int i = 0; i < 10; i++) {
